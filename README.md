...
[![PyPI](https://img.shields.io/pypi/v/maaker-excalidraw-mcp)](https://pypi.org/project/maaker-excalidraw-mcp/)
[![Downloads](https://img.shields.io/pypi/dm/maaker-excalidraw-mcp)](https://pypistats.org/packages/maaker-excalidraw-mcp)
...
Every image below was generated by a **single tool call** — no coordinates, no manual layout. The `.excalidraw` sources live in [`docs/showcase/`](docs/showcase/); drag any of them onto [excalidraw.com](https://excalidraw.com) to keep editing.

| Flowchart (branches + cycle + CJK) | Layered architecture |
|---|---|
| ![Flowchart](docs/showcase/flowchart.svg) | ![Architecture](docs/showcase/architecture.svg) |

![Mind map](docs/showcase/mindmap.svg)
